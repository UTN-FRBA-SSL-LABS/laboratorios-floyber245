...
> R: Falla, espera 2800 y obtiene 2050.
...
> R: En la línea 24, dice que el total es igual al precio del ítem.

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R: Multiplicar el precio del ítem por la cantidad.
...
> R: Falla, devuelve: '[FAIL] carrito_agregar(&c, p) => esperado 0, obtenido 1  (linea 68)'
...
> R: El unitario prueba una función específica, el de integración verifica que multiples funciones interactúen entre sí. Por ende, el unitario detectó primero el bug.
...
> R: Porque escribe, sin comprobar, en los espacios de memoria que casualmente estén justo después de la que ya estaba reservada para el array.
...
> R: Corriendo tests, te asegurás completamente de si algo no está funcionando, a diferencia de nuestra visión, que puede equivocarse.
...
> R: Porque, como la cantidad era 1, el resultado de la multiplicación casualmente coincidió con el resultado esperado (350 * 1).
